...
玩家在组间小会中处理身体部门的荒诞发言。每次处理都会影响四个公司 KPI:

- **现金流**: 对应氧气、恢复资源、心肺余量。
- **士气**: 对应肌肉配合度、身体愿不愿意继续练。
- **增长**: 对应泵感、训练刺激、进步感。
- **泡沫**: 对应借口、摸鱼、自我欺骗、虚假繁荣。
...
- **发糖**
  - 基本气质: 安抚部门、提升士气，消耗现金流。
  - 文案感: 给员工一点甜头。

- **打鸡血**
  - 基本气质: 提升增长或短期复工意愿，可能伤士气或推高泡沫。
  - 文案感: 靠情绪燃料继续冲。
...
- `画饼成功: 增长曲线抬头，泡沫也开始鼓掌。`
- `发糖成功: 腿部事业群停止拍桌，但现金流少了一截。`
- `打鸡血成功: 胸部事业部士气暴涨，心肺财务部开始翻白眼。`
...
4. **Extension And Early Restart**
   - Extend adds agenda items and泡沫 risk.
